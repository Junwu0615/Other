...
with open('Other_clone.json', 'r') as fh: now = json.load(fh)
with open('Other_clone_before.json', 'r') as fh: before = json.load(fh)
...
with open('Other_clone.json', 'w', encoding='utf-8') as fh: json.dump(latest, fh, ensure_ascii=False, indent=4)